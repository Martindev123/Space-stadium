...
class Game():
    ...
    def render_info(self, pen, score, active_enemies = 0):
        ...
        character_pen.draw_string(pen, "SCORE {}".format(player.score), 400, 200)
        character_pen.draw_string(pen, "LIVES {}".format(player.lives), 400, 120)
...
wn.onkeypress(player.backward, "Down")
wn.onkeyrelease(player.decelerate, "Down")
